        ...
        <header>
          <div className="main__container-header__layout">
            ...
            <nav>
              <ul>
                <li>        
                  <a href={`/`} style={{textDecoration: "solid underline #FFBD0C 3px"}}>Города и поселки</a>
                </li>
                <li>
                  <a href={`/production`}>Производство и промышленность</a>
                </li>
                <li>
                  <Link href={`/pages/shop`}>Офисы и магазины</Link>
                </li>
                <li>
